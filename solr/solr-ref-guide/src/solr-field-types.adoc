...
The field type defines how Solr should interpret data in a field and how the field will be queried. There are many field types included with Solr by default, and they can also be defined locally.
